...
extension View {
    ...
    /// - On **iOS 14, macOS 11**, and later, it uses the new [`accessibilityRemoveTraits(_:)`](https://developer.apple.com/documentation/swiftui/view/accessibilityremovetraits(_:)) method.
