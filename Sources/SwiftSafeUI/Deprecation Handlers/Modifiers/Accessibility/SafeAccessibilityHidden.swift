...
extension View {
    ...
    /// - On **iOS 14, iPadOS 14, macOS 11**, and later, it uses the new [`accessibilityHidden(_:)`](https://developer.apple.com/documentation/swiftui/view/accessibilityhidden(_:)) method.
